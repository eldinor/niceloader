...
export class NiceLoaderReport {
  ...
  uploadModel(scene: Scene, arr: Array<MeshAssetTask>) {
    ...
    loadButton!.onchange = function (evt) {
      ...
      fd.push(files[0].size);
      console.log("fd", fd);

      let sizeInMB = (files[0].size / (1024 * 1024)).toFixed(2);

      fd2.size = sizeInMB + " MB";
      console.log(fd2);

      console.log(sizeInMB + " MB" + " MB");
