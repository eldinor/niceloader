...
*/ //
    ...
    const pointerImage = new BABYLON_GUI.Image(
      "pointer",
      "https://raw.githubusercontent.com/eldinor/ForBJS/master/dot.png"
    );
    ...
    var logo = new BABYLON_GUI.Image(
      "logo",
      "https://raw.githubusercontent.com/eldinor/ForBJS/master/logo-babylonpress-PB-s.png"
    );
    logo.width = "72px";
    logo.height = "40px";
    logo.horizontalAlignment = 1;
    logo.verticalAlignment = 1;
    logo.paddingBottom = 5;
    logo.paddingRight = 5;

    logo.onPointerUpObservable.add(function () {
      window.open("https://babylonpress.org/", "_blank");
    });
